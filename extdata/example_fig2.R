...
plot_activities_human = function(country, id_tab, act_file) {
    ...
    ggplot(cc, aes(x = hour, y = value, fill = Location, group = country, width = width)) + 
        ...
        scale_fill_manual(values = c("#fd8d3c", "#fdd0a2", "#74c476", "#c2e699")) 
}
...
p_act = ggarrange(p_act_humans, p_act_mosquitoes, labels = c("B", "C"), ncol = 2, nrow = 1, widths = c(1.6, 2), legend = "top")
